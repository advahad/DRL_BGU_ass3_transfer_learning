...
class AlgorithmParams:
    def __init__(self, env, render, max_episodes, max_steps, discount_factor, policy_learning_rate, value_net_learning_rate,
...
def train_model(policy, state_value_network, network_params, algorithm_params, logs_path, model_path=None, save_model = False):
